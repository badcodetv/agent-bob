...
// The replay / emit surface moved to the org chart's propagation panel
// (doc 28 §4.2, work plan 29 C1). Its behaviour is covered by
// EmitEventControl.test.tsx — the extracted control both surfaces share — so
// nothing was lost here beyond the tab that used to host it.
