...
(`api/src/orange/client.ts:255-270`) **always supplies one — the upstream's**. So an Orange **502**
...
- **Repo:** agent-orange (the output file only); reads `agent-wolf` **read-only**
